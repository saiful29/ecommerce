...
<head>
    ...
    <meta name="author" content="Shaiful">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('category.index') }}">Create</a>
                    <a class="collapse-item" href="{{ route('category.showall') }}">All Category</a>
                    <a class="collapse-item" href="{{ route('subcategory.create') }}">Subcategory</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseT" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('brand.index') }}">Create</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{asset('product')}}">Colors</a>
                    <a class="collapse-item" href="{{route('product.create')}}">Borders</a>
                    <a class="collapse-item" href="{{route('product.index')}}">Animations</a>
                    <a class="collapse-item" href="{{route('product.upload')}}">Other</a>
                </div>
            </div>
        </li>
